...
<script type="text/javascript" src="../js/graph0.js"></script>
...
<div id= "wrapper_graphs">
	...
	<span id="position">
		<div id= "containerLG" >
			<h3>Hour Graph</h3>
			<p>This is a graph of the activity in an <strong>Hour</strong>. This graph is updated every 10 seconds.</p>
			<br/>
			<div id="container" style="width: 650px; height: 430px; margin: 0 auto"></div>	
			<input type="submit" value="Reset Graph to current time" id="submit" />
		</div>
	</span>
</div>
